...
public class MainFrame extends javax.swing.JFrame {
    ...
    void func() {
        ...
        for (int i = 0; i < emailTextField.getText().length(); i++) {
            b=emailTextField.getText().charAt(i)=='@';
                    }
        for (int i = 0; i < emailTextField.getText().length(); i++) {
            c=emailTextField.getText().charAt(i)=='.';
        }
    }
...
//             c[i]=email.;
            if (email.charAt(i) == '@' && b) {
                ...
                return "Invalid E-mail address\nAn email address doesn't have 2 @ signs";
            }
       ...
       return (i==0)?"Invalid E-mail address wtf":"";
    }
    ...
    private void emailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emailButtonActionPerformed
        ...
        emailLabel.setText(test(emailTextField.getText()));
